...
class ansimuz_options_page{
	...
	add_theme_page(ANSIMUZ_THEME, "Theme ". $this->page_title, 'administrator', $this->file_name, array(&$this, 'ansimuz_generate_page'), get_template_directory_uri() .'/functions/img/bag.png');

/*
		if(!isset($this->info['sublevel'])){
			add_theme_page(ANSIMUZ_THEME, ANSIMUZ_THEME, 'administrator', $this->file_name, array(&$this, 'ansimuz_generate_page'), get_template_directory_uri() .'/functions/img/bag.png'); 
		}
		else{			
			add_theme_page(ANSIMUZ_MAINMENU_NAME, $this->page_title, $this->page_title, 'administrator', $this->file_name, array(&$this, 'ansimuz_generate_page')); 		
		}*/
